...
exports.resolvers = {
    Query: {
        ...
        getUserById: (_1, _a) => __awaiter(void 0, [_1, _a], void 0, function* (_, { id }) {
            try {
                const [result] = yield index_js_1.graphqlDb.select().from(index_js_2.Users).where((0, drizzle_orm_1.eq)(index_js_2.Users.id, id)).execute();
                ;
                return result;
            }
            catch (err) {
    ...
    Mutation: {
        ...
        deleteUser: (_1, _a) => __awaiter(void 0, [_1, _a], void 0, function* (_, { id }) {
            try {
                yield index_js_1.graphqlDb
                    .delete(index_js_2.Users)
